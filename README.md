...
Τελικά το καλύτερο score το λαμβάνω από το benchmark specmcf με την πρώτη υλοποίηση και είναι ίσο με 821.91. Το cpi που καταφέρνω είναι ίσο με cpi = 1.160209 και το κόστος είναι μονάχα cost = 708.42. Το specmcf με τις default λειτουργίες είχε ήδη το 2ο καλύτερο cpi. Για το βέλτιστο cpi στο specmcf_5 ίσο με 1.108120, αναγκάζομαι να χρησιμοποιήσω και ολόκληρη της L1d cache και την L2 cache, ενώ το chunk είναι επίσης πολύ μεγάλο και ίσο με 256bytes. Το καλύτερο score βλέπω πως χρειάστηκε αρκετά μικρότερες τιμές τόσο για τις μνήμες cache, όσο και για το chunk size (στα 64 bytes στο specmcf_0. Τόσο είναι αρκετό και μάλλον θα ήταν αρκετό και για το specmcf_5, αν και δε θα μείωνε σημαντικά το κόστος αυτή η αλλαγή) για ένα σχεδόν εξίσου καλό cpi (μικρότερο κατά 0.06).
