...
Τελικά το καλύτερο score το λαμβάνω στο benchmark specmcf με την πρώτη υλοποίηση και είναι ίσο με 821.91. Το cpi που καταφέρνω είναι ίσο με cpi = 1.160209 και το κόστος είναι μονάχα cost = 708.42. Το specmcf με τις default λειτουργίες είχε ήδη το 2ο καλύτερο cpi. 
...
Φυσικά, παρόμοια ανάλυση μπορώ να κάνω για όλα τα benchmarks που τρέχουν στη CPU και να αντλήσω δεδομένα ως προς τη βελτιστοποίησή τους και το κόστος τους. Αξίζει να αναφερθεί, για παράδειγμα, πως το κόστος του specsjeng_3 που επιτυγχάνει και το καλύτερο cpi, είναι ίσο με score = 46376.34, άρα cost = 8967.55. Είναι πολύ υψηλό το κόστος, όμως αν οι απαιτήσεις του επεξεργαστή μας θέλουμε να έχουν πολύ υψηλά performances σε dynamic code διερμηνείες, σε allocation μνήμης κλπ, οφείλουμε να πληρώσουμε ακριβότερα.

Επομένως, καταλαβαίνει κανείς πως η δουλειά του αρχιτέκτονα δε τελειώνει εδώ. Οφείλουν να γίνουν κι άλλα πειράματα και πολλα στάδια προσομοιωσεων ακόμα, αφού έχουν μαζευτεί αυτά τα πρώτα δεδομένα (τι φαίνεται να βελτιστοποιεί την υλοποίηση του κάθε benchmark ξεχωριστά), με σκοπό να βρεθεί αυτή η τέλεια τομή κόστους και cpi για κάθε benchmark, φυσικά κερδίζοντας κάτι και χάνοντας κάτι με βάση τις απαιτήσεις της κατασκευής μας. Δηλαδή, στο τέλος πρέπει να καταλήξουμε με ένα τελικό σετ χαρακτηριστικών της CPU που θα βελτιστοποιει (ή θα πληρεί τις απαιτήσεις μας σε) καθε benchmark. Αυτο δεν ζητείται, φυσικά, από την παρούσα εργασία, η οποία έχει ως σκοπό την εισαγωγή μας στα εργαλεία και στην αρχιτεκτονική προηγμένων υπολογιστών. 
Τέλος αναφοράς.
